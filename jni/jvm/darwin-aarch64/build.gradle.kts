 ...
 * Ships libsdl_image_jni.dylib as a classpath resource at
 * /cn/enaium/sdl/image/native/darwin-aarch64/, which ImageNativeLoader
...
val libFile = "libsdl_image_jni.dylib"
...
val buildJniLibrary by tasks.registering(Exec::class) {
    group = "build"
    description = "Builds libsdl_image_jni.dylib for $classifier."
    onlyIf { canBuildHere }
